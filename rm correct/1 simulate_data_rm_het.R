...
for (e in 1:1000) {
      ...
      sigma = matrix(c(SDloops[c],corloops[d],corloops[d],corloops[d],corloops[d],corloops[d],
                   corloops[d],SDloops[c]*2,corloops[d],corloops[d],corloops[d],corloops[d],
                   corloops[d],corloops[d],SDloops[c],corloops[d],corloops[d],corloops[d],
                   corloops[d],corloops[d],corloops[d],SDloops[c]*2,corloops[d],corloops[d],
                   corloops[d],corloops[d],corloops[d],corloops[d],SDloops[c],corloops[d],
                   corloops[d],corloops[d],corloops[d],corloops[d],corloops[d],SDloops[c]*2), nrow = 6, ncol = 6)
      }
  ...
  filename = paste(round_sim, ".csv", sep = "")
  datalines = (abs(round_sim-999):round_sim)
...
library(gmailr)
test_email <- mime(
  To = "4092911095@txt.att.net",
  From = "buchananlab@gmail.com",
  Subject = "your sims are done",
  body = "done done done")
send_message(test_email)
write.csv(mydata, "sim_rm_data_het.csv")
